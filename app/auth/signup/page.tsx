...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(formatAuthError(error, window.location.hostname));
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-brand-600 to-brand-700 px-8 py-8">
            ...
            <p className="text-brand-100">Create a private shortlist and continue your research on any device</p>
          </div>
          ...
          <div className="px-8 py-10">
              ...
              <button
                ...
                onClick={async () => {
                  try {
                    ...
                    setError(formatAuthError(signupError, window.location.hostname));
                  } finally {
                    setLoading(false);
                  }
                }}
                className="flex w-full items-center justify-center gap-2 px-4 py-2.5 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors font-medium text-slate-700 text-sm disabled:opacity-50"
              >
            ...
            <p className="mb-6 text-center text-sm leading-6 text-slate-500">
              No payment details are required. Your account is used only for saved colleges and community features.
            </p>

    ...
    <main className="min-h-screen bg-slate-50 px-4 py-12">
      <article className="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white p-7 shadow-sm sm:p-10">
        ...
        <div className="mt-8 space-y-7 leading-7 text-slate-700">
          ...
          <Section title="Pro subscriptions">The amount, currency, billing interval, taxes, trial terms, cancellation timing, and available payment methods are shown in Stripe Checkout. Subscription access depends on successful payment and may be suspended when Stripe reports an inactive, canceled, or past-due subscription. Users can manage supported billing actions through the customer portal.</Section>
        ...
        <p className="mt-8 rounded-xl bg-amber-50 p-4 text-sm leading-6 text-amber-900">Before commercial launch, the operator must add its legal entity, contact details, cancellation/refund policy, tax treatment, governing jurisdiction, and applicable education and consumer-protection terms.</p>
      </article>
    </main>
  );
}

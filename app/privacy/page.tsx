    ...
    <main className="min-h-screen bg-slate-50 px-4 py-12">
      <article className="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white p-7 shadow-sm sm:p-10">
        ...
        <div className="mt-8 space-y-7 leading-7 text-slate-700">
          ...
          <Section title="Sharing and retention">Firebase, Wikimedia, and the configured Google Places provider may process data needed to provide their services. We do not sell personal information. Account data remains until it is deleted by the project operator or as required for security and legal obligations.</Section>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative -mt-16 pb-8">
        <div className="flex flex-col md:flex-row gap-6 md:items-end">
          ...
          <div className="flex-1 pt-2 md:pt-0">
            ...
            <div className="flex flex-wrap items-center gap-4 text-slate-600 text-sm md:text-base">
              ...
              <div className="flex items-center">
                ...
                ({college.reviewCount} reference ratings)
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3 md:w-auto w-full mt-4 md:mt-0">
            <a href={college.website} target="_blank" rel="noreferrer" className="flex-1 md:flex-none bg-brand-600 hover:bg-brand-700 text-center text-white font-bold py-3 px-6 rounded-xl transition-colors shadow-sm">
              Official Website
            </a>
            <Link href="/predictor" className="flex-1 md:flex-none bg-white hover:bg-slate-50 text-center text-slate-700 border border-slate-200 font-bold py-3 px-6 rounded-xl transition-colors shadow-sm">
              Check Cutoff
            </Link>
          </div>
        </div>
